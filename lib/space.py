class Space:
    ...
    def __repr__(self):
        return f"ID: {self.id}. Property name: {self.name}. Location: {self.location}. Property Description: {self.description}. Price per night: £{self.price}. Owner name and contact: {self.owner}."
