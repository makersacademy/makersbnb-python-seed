...
def test_sign_up_inputs_with_invalid_entry_all_error(page, test_web_address, db_connection):
    ...
    expect(errors_tag).to_have_text("There were errors in your submission: Email can't be blank, Password can't be blank, Passwords must be 8 characters or longer, Passwords must include one of the following special characters(! @ $ % &), Passwords must include a Capital Letter")
