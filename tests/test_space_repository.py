...
def test_all(db_connection):
    ...
    assert spaces == [Space(1, 'house with a pool', 99.99, 1, 'pool house', '04-03-2024', '31-03-2024'), Space(2, 'house with a garden', 199.99, 2, 'garden house', '01-04-2024', '30-04-2024')]
