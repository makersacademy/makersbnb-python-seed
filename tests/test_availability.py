...
def test_constructs_availability():
    availability = Availability(1, 1, date(2025,1,1), True)
...
def test_availability_format_nicely():
    availability = Availability(1, 1, date(2025,1,1), True)
    assert availability == Availability(1, 1, date(2025,1,1), True)

def test_availability_are_equal():
    availability1 = Availability(1, 1, date(2025,1,1), True)
    availability2 = Availability(1, 1, date(2025,1,1), True)
