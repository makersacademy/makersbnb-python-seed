...
"""
def test_construct():
    booking = Booking(1, "2024-02-23", "2024-02-24",1)
    assert booking.id == 1
...
def test_spaces_are_equal():
    booking1 = Booking(1, "2024-02-23", "2024-02-24",1)
    booking2 = Booking(1, "2024-02-23", "2024-02-24",1)
...
def test_format():
    booking = Booking(1, "2024-02-23", "2024-02-24", 1)
    assert str(booking) == "Booking(1, 2024-02-23, 2024-02-24, 1)"