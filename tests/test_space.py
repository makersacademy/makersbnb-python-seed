...
def test_properties_of_space():
    apartment1 = Space(1, 'Apartment 1', 'Description 1', 100, '2024-01-01', '2024-04-01')
    apartment1.id == 1
...
def test_spaces_are_equal():
    apartment1 = Space(1, 'Apartment 1', 'Description 1', 100, '2024-01-01', '2024-04-01')
    apartment2 = Space(1, 'Apartment 1', 'Description 1', 100, '2024-01-01', '2024-04-01')
...
def test_nice_format():
    apartment1 = Space(1, 'Apartment 1', 'Description 1', 100, '2024-01-01', '2024-04-01')
    assert apartment1.nice_format() == "Apartment 1, Description 1, 100, 2024-01-01, 2024-04-01"