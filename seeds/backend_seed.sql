...
INSERT INTO properties (property_type, description, price, location, start_date, end_date, available, user_id) 
    VALUES ('Flat', 'Sunny 2bdr flat in city centre', 100, 'Hackney', '2023-10-30', '2023-12-31', '1', '1' );
INSERT INTO properties (property_type, description, price, location, start_date, end_date, available, user_id) 
    VALUES ('Maisonette','Large 3bdr 2ba with spacious garden', 300, 'Brixton', '2023-10-30', '2023-12-31', '1', '2' );
INSERT INTO properties (property_type, description, price, location, start_date, end_date, available, user_id) 
    VALUES ('Annex','Double bed 2floor with ensuite', 80, 'Brighton', '2023-10-30', '2023-12-31', '1', '3' );
